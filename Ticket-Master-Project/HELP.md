...
* The original package name 'it.project.TicketMaster ' is invalid and this project uses 'it.project.TicketMaster' instead.
...
```
$ docker run --rm -p 8080:8080 Ticket-Master-Project:0.0.1-SNAPSHOT
```
